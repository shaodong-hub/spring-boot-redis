...
public class ConfigConnectionFactory {
    ...
    public LettuceConnectionFactory redisConnectionFactory(int database) {
        ...
        return createLettuceConnectionFactory(clientConfig, database);
    }
    ...
    private void customize(LettuceClientConfiguration.LettuceClientConfigurationBuilder builder) {
        for (LettuceClientConfigurationBuilderCustomizer customizer : this.builderCustomizers.getIfAvailable(Collections::emptyList)) {
